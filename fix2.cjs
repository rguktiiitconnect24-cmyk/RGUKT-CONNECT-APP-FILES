...
const missingBlock = `                {/* Timetable Editor */}
...
let idx1 = content.indexOf('{/* Timetable Editor */}');
let idx2 = content.indexOf('                                                setIsEditMode(false);');

if (idx1 !== -1 && idx2 !== -1) {
    content = content.substring(0, idx1) + missingBlock + content.substring(idx2);
    fs.writeFileSync(path, content, 'utf8');
    console.log('Fixed TimetableManagement.jsx successfully');
} else {
    console.log('Failed to find boundaries. idx1:', idx1, 'idx2:', idx2);
}
