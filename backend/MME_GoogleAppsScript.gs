/**
 * Google Apps Script for PDF Upload System - MME Department
 * 
 ...
 * 7. Copy the Web App URL and update it in your React application (src/config/driveBackends.js) for 'mme'.
 */
...
function handleUpload(payload) {
  ...
  // Strict Validation for MME Department
  if (branch.toLowerCase() !== 'mme') {
    return createJsonResponse({ status: "error", message: "Unauthorized section. This backend is strictly reserved for Metallurgical & Materials Engineering (MME)." });
  }
