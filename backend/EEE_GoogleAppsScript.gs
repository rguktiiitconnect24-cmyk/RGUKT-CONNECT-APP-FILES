/**
 * Google Apps Script for PDF Upload System - EEE Department
 * 
 ...
 * 7. Copy the Web App URL and update it in your React application (src/config/driveBackends.js) for 'eee'.
 */
...
function handleUpload(payload) {
  ...
  // Strict Validation for EEE Department
  if (branch.toLowerCase() !== 'eee') {
    return createJsonResponse({ status: "error", message: "Unauthorized section. This backend is strictly reserved for Electrical & Electronics Engineering (EEE)." });
  }
