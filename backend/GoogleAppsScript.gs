/**
 * Google Apps Script for PDF Upload System
 * 
 ...
 * 7. Copy the Web App URL and update it in your React application.
 */
...
function handleUpload(payload) {
  ...
  // Strict Validation for AIML Year 1
  if (branch !== 'aiml' || year !== 'btech1') {
    return createJsonResponse({ status: "error", message: "Unauthorized section. This backend is strictly reserved for AIML Year 1." });
  }
